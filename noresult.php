...
if($type>=1 && $type<5){
    ...
    $sql="select  词条.用户名,词条.商品图片,词条.商店名,词条.地址,词条.商品名,词条.销售价格,商家.印象标签,商家.口碑,词条.词条创建时间  from  词条,商家,商品
                                     where  词条.商店名=商家.商店名  and  词条.地址=商家.地址  and 词条.商品名=商品.商品名 and 
                                      (商品.商标 not like '%{$str}%'  and  词条.商品名 not like '%{$str}%' and  商品.类型 not like '%{$str}%') order by 口碑  DESC;";
    //   }
}else if($type==5)
    $sql="select 词条.用户名,词条.商品图片,词条.商店名,词条.地址,词条.商品名,词条.销售价格,商家.印象标签,商家.口碑,词条.词条创建时间  from  词条,商品,商家
                                      where  词条.商店名=商家.商店名  and  词条.地址=商家.地址  and  商品.商品名=词条.商品名 order by 词条.词条创建时间  DESC;";
else{
    $sql="select 词条.用户名,词条.商品图片,词条.商店名,词条.地址,词条.商品名,词条.销售价格,商家.印象标签,商家.口碑,词条.词条创建时间  from  词条,商品,商家
                                      where  词条.商店名=商家.商店名  and  词条.地址=商家.地址  and  商品.商品名=词条.商品名 order by 口碑  DESC;";
}
